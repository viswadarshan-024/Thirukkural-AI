...
def sidebar_settings():
    with st.sidebar:
        ...
        <div style="background-color: #2d2d3a; padding: 15px; border-radius: 10px; margin: 20px 0;">
            ...
            <p>இந்த செயலி உங்கள் வாழ்க்கை கேள்விகளுக்கு ஏற்ற திருக்குறளைக் கண்டறிந்து, அதன் அர்த்தத்தையும் உங்கள் சூழலுக்கேற்ற ஆலோசனைகளையும் வழங்குகிறது.</p>

            <p><b>எடுத்துக்காட்டு கேள்விகள்:</b></p>
            <ul>
